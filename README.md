...
### 🚀 What I'm Building
- 🔭 **Currently working on:** **iLou Foundation** (Building the architecture for next-gen project management).
- 📊 **Data Focus:** Building **Financial Recommender Systems** and "Spotify Wrapped"-style **Data Storytelling** engines.
- 🌱 **Learning:** Researching the intersection of **IoT** and **Quantum Computing** for logistics.
